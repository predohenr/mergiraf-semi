...
mod tests {
    ...
    fn one_element() {
        ...
        let node = ctx.parse_rust("fn x() -> i32 { 1 + 2 }").redundant_root();
    ...
    fn two_elements_same_height() {
        ...
        let node1 = ctx.parse_rust("fn y() -> u8 { 1 + 2 }").redundant_root();
        priority_list.push(node1);
        let node2 = ctx.parse_rust("fn z() { 3 *  5 }").redundant_root();
    ...
    fn two_elements_increasing_height() {
        ...
        let node1 = ctx.parse_rust("fn a() { 1 + 2 }").redundant_root();
        priority_list.push(node1);
        let node2 = ctx.parse_rust("fn b() { 3 * (5 + 1) }").redundant_root();
        priority_list.push(node2);
    ...
    fn two_elements_decreasing_height() {
        ...
        let node1 = ctx.parse_rust("fn c() { 1 + (2 + 5) }").redundant_root();
        priority_list.push(node1);
        let node2 = ctx.parse_rust("fn d() { 3 * 9 }").redundant_root();
        priority_list.push(node2);
    ...
    fn open() {
        ...
        let node1 = ctx.parse_rust("fn x() { 1 + (2 + 5) }").redundant_root();
